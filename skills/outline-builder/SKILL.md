...
1. Determine the target format and audience.
2. Extract the main thesis, supporting points, evidence, examples, objections, and gaps.
3. Arrange sections in a logical reading order.
4. Keep headings specific enough that the user can draft from them directly.
...
> **Outline**
>
> 1. Hook — the commute people got back
> 2. Benefits of remote: reclaimed time, deep focus
> 3. The costs: isolation, harder onboarding
> 4. Why hybrid splits the difference
> 5. What makes hybrid work: manager training
>
> **Evidence to include**
>
