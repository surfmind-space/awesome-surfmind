...
1. Assess the headline, offer, audience clarity, proof, CTA, objections, visual hierarchy, friction, trust signals, and mobile/readability clues.
2. Tie each critique to a visible page element or a missing one; separate quick wins from deeper positioning issues.
3. Suggest concrete copy or structure rewrites, not generic marketing clichés (e.g. **Before:** "Get Started" → **After:** "Start your free 14-day trial — no card needed").
4. Separate supported facts, tool-derived context, and your own assumptions or recommendations rather than blending them.
...
>
> _No pricing, traffic, or audience data is on the page — confirm the target user before committing to the headline rewrite._
