...
1. Extract positioning, target audience, products/offers, pricing cues, proof points, messaging, CTAs, and objections handled.
2. Compare visible claims against the user's own context only when they've provided it; use web search or browser/market tools for external validation when available.
3. Identify likely strengths, weaknesses, differentiation opportunities, and open questions to research.
4. Separate supported facts, tool-derived context, and your own assumptions or recommendations — label them rather than blending them.
